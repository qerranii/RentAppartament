      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-3xl font-bold text-green-600">${analytics.price_stats.avg_price.toFixed(0)}</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            <p className="text-gray-600 text-sm">Min Price</p>
            <p className="text-3xl font-bold text-yellow-600">${analytics.price_stats.min_price.toFixed(0)}</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            <p className="text-gray-600 text-sm">Max Price</p>
            <p className="text-3xl font-bold text-red-600">${analytics.price_stats.max_price.toFixed(0)}</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={analytics.by_district}>
